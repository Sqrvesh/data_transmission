...
main_title = customtkinter.CTkLabel(main_frame, text="Server Screen", font = ("Satoshi-Variable.ttf", 40))
main_title.grid(row=0, column=0, padx=20, pady=20, sticky = "nsew", columnspan = 2)

client_msg_title = customtkinter.CTkLabel(main_frame, text="Text from Client:", font = ("Satoshi-Variable.ttf", 30))
...
send_msg_title = customtkinter.CTkLabel(main_frame, text="Reply to Client:", font = ("Satoshi-Variable.ttf", 30))
